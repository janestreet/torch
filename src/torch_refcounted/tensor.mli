...
val nll_loss : ?reduction:Reduction.t -> t -> targets:t -> t
...
val bce_loss : ?reduction:Reduction.t -> t -> targets:t -> t
...
val bce_loss_with_logits : ?reduction:Reduction.t -> t -> targets:t -> t
...
val mse_loss : ?reduction:Reduction.t -> t -> t -> t
val huber_loss : ?reduction:Reduction.t -> t -> t -> t
