...
CAMLprim value ml_stbi_write_png(value filename, value w, value h, value comp,
                                 value ba) {
...
CAMLprim value ml_stbi_write_bmp(value filename, value w, value h, value comp,
                                 value ba) {
  CAMLparam5(filename, w, h, comp, ba);
  int result;
...
CAMLprim value ml_stbi_write_tga(value filename, value w, value h, value comp,
                                 value ba) {
  CAMLparam5(filename, w, h, comp, ba);
  int result;
...
CAMLprim value ml_stbi_write_hdr(value filename, value w, value h, value comp,
                                 value ba) {
  CAMLparam5(filename, w, h, comp, ba);
  int result;
...
CAMLprim value ml_stbi_write_jpg_native(value filename, value w, value h,
                                        value comp, value q, value ba) {
...
CAMLprim value ml_stbi_write_jpg_bytecode(value *argv, int nargs) {
  return ml_stbi_write_jpg_native(argv[0], argv[1], argv[2], argv[3], argv[4],
                                  argv[5]);
}
