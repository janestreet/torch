...
void atg_std_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
void atg_std_correction_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
...
void atg_std_mean_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
void atg_std_mean_correction_out(tensor *, tensor out0, tensor out1, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
...
void atg_var_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
void atg_var_correction_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
...
void atg_var_mean_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
void atg_var_mean_correction_out(tensor *, tensor out0, tensor out1, tensor self, int64_t *dim_data, int dim_len, int64_t correction_v, int correction_null, int keepdim);
