...
void atg__scaled_dot_product_attention_math(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value, gc_tensor attn_mask, double dropout_p, int is_causal, gc_tensor dropout_mask, double scale_v, int scale_null);
void atg__scaled_dot_product_cudnn_attention(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value, double dropout_p, int is_causal, int return_debug_mask, double scale_v, int scale_null);
...
void atg__scaled_mm(raw_tensor *, gc_tensor self, gc_tensor mat2, gc_tensor bias, int out_dtype, gc_tensor scale_a, gc_tensor scale_b, gc_tensor scale_result, int use_fast_accum);
void atg__scaled_mm_out(raw_tensor *, gc_tensor out, gc_tensor out_amax, gc_tensor self, gc_tensor mat2, gc_tensor bias, int out_dtype, gc_tensor scale_a, gc_tensor scale_b, gc_tensor scale_result, int use_fast_accum);
