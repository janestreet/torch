...
void atg__convolution_mode(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg__flash_attention_backward(tensor *, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, tensor philox_seed, tensor philox_offset, double scale_v, int scale_null);
...
void atg__functional_assert_async(tensor *, tensor self, char * assert_msg, tensor dep_token);
void atg__functional_sym_constrain_range(tensor *, scalar size, int64_t min_v, int min_null, int64_t max_v, int max_null, tensor dep_token);
void atg__functional_sym_constrain_range_for_size(tensor *, scalar size, int64_t min_v, int min_null, int64_t max_v, int max_null, tensor dep_token);
...
void atg__linalg_eigh(tensor *, tensor A, char * UPLO, int compute_v);
void atg__linalg_eigh_eigenvalues(tensor *, tensor eigenvalues, tensor eigenvectors, tensor A, char * UPLO, int compute_v);
...
void atg__linalg_svd(tensor *, tensor A, int full_matrices, int compute_uv, char * driver);
void atg__linalg_svd_u(tensor *, tensor U, tensor S, tensor Vh, tensor A, int full_matrices, int compute_uv, char * driver);
...
void atg__masked_softmax(tensor *, tensor self, tensor mask, int64_t dim_v, int dim_null, int64_t mask_type_v, int mask_type_null);
void atg__masked_softmax_backward(tensor *, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int dim_null);
void atg__masked_softmax_backward_out(tensor *, tensor out, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int dim_null);
void atg__masked_softmax_out(tensor *, tensor out, tensor self, tensor mask, int64_t dim_v, int dim_null, int64_t mask_type_v, int mask_type_null);
...
void atg__native_multi_head_attention(tensor *, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights, int64_t mask_type_v, int mask_type_null);
...
void atg__pad_enum(tensor *, tensor self, int64_t *pad_data, int pad_len, int64_t mode, double value_v, int value_null);
...
void atg__scaled_dot_product_attention_math(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, int scale_null);
void atg__scaled_dot_product_efficient_attention(tensor *, tensor query, tensor key, tensor value, tensor attn_bias, int compute_log_sumexp, double dropout_p, int is_causal, double scale_v, int scale_null);
...
void atg__scatter_reduce(tensor *, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self);
void atg__scatter_reduce_(tensor *, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self);
void atg__scatter_reduce_two_out(tensor *, tensor out, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self);
void atg__segment_reduce_backward(tensor *, tensor grad, tensor output, tensor data, char * reduce, tensor lengths, tensor offsets, int64_t axis, scalar initial);
void atg__segment_reduce_backward_out(tensor *, tensor out, tensor grad, tensor output, tensor data, char * reduce, tensor lengths, tensor offsets, int64_t axis, scalar initial);
...
void atg__sparse_mm_reduce(tensor *, tensor sparse, tensor dense, char * reduce);
void atg__sparse_mm_reduce_impl(tensor *, tensor self, tensor other, char * reduce);
void atg__sparse_semi_structured_linear(tensor *, tensor input, tensor weight, tensor meta, tensor bias, char * activation);
...
void atg__test_ambiguous_defaults_b(tensor *, tensor dummy, int64_t a, char * b);
...
void atg__test_string_default(tensor *, tensor dummy, char * a, char * b);
void atg__test_warn_in_autograd(tensor *, tensor self);
void atg__test_warn_in_autograd_out(tensor *, tensor out, tensor self);
void atg__thnn_differentiable_gru_cell_backward(tensor *, tensor grad_hy, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias);
void atg__thnn_differentiable_lstm_cell_backward(tensor *, tensor grad_hy, tensor grad_cy, tensor input_gates, tensor hidden_gates, tensor input_bias, tensor hidden_bias, tensor cx, tensor cy);
void atg__thnn_fused_gru_cell(tensor *, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias);
void atg__thnn_fused_gru_cell_backward(tensor *, tensor grad_hy, tensor workspace, int has_bias);
void atg__thnn_fused_gru_cell_backward_out(tensor *, tensor out0, tensor out1, tensor out2, tensor out3, tensor out4, tensor grad_hy, tensor workspace, int has_bias);
void atg__thnn_fused_gru_cell_out(tensor *, tensor out0, tensor out1, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias);
void atg__thnn_fused_lstm_cell(tensor *, tensor input_gates, tensor hidden_gates, tensor cx, tensor input_bias, tensor hidden_bias);
void atg__thnn_fused_lstm_cell_backward(tensor *, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias);
void atg__thnn_fused_lstm_cell_backward_impl(tensor *, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias);
void atg__thnn_fused_lstm_cell_backward_impl_out(tensor *, tensor out0, tensor out1, tensor out2, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias);
void atg__thnn_fused_lstm_cell_out(tensor *, tensor out0, tensor out1, tensor out2, tensor input_gates, tensor hidden_gates, tensor cx, tensor input_bias, tensor hidden_bias);
...
void atg__to_sparse_bsc(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_bsc_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_bsr(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_bsr_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_csc(tensor *, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_csc_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_csr(tensor *, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg__to_sparse_csr_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null);
...
void atg__transformer_encoder_layer_fwd(tensor *, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int mask_type_null);
void atg__transformer_encoder_layer_fwd_out(tensor *, tensor out, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int mask_type_null);
...
void atg__upsample_bicubic2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bicubic2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bicubic2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bicubic2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg__upsample_bilinear2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bilinear2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bilinear2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_bilinear2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg__upsample_nearest_exact1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null);
void atg__upsample_nearest_exact1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null);
void atg__upsample_nearest_exact1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null);
void atg__upsample_nearest_exact1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null);
...
void atg__upsample_nearest_exact2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg__upsample_nearest_exact3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg__upsample_nearest_exact3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_aminmax(tensor *, tensor self, int64_t dim_v, int dim_null, int keepdim);
void atg_aminmax_out(tensor *, tensor min, tensor max, tensor self, int64_t dim_v, int dim_null, int keepdim);
...
void atg_argmax(tensor *, tensor self, int64_t dim_v, int dim_null, int keepdim);
void atg_argmax_out(tensor *, tensor out, tensor self, int64_t dim_v, int dim_null, int keepdim);
void atg_argmin(tensor *, tensor self, int64_t dim_v, int dim_null, int keepdim);
void atg_argmin_out(tensor *, tensor out, tensor self, int64_t dim_v, int dim_null, int keepdim);
...
void atg_as_strided(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
void atg_as_strided_(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
void atg_as_strided_copy(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
void atg_as_strided_copy_out(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
void atg_as_strided_scatter(tensor *, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
void atg_as_strided_scatter_out(tensor *, tensor out, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null);
...
void atg_avg_pool2d(tensor *, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
void atg_avg_pool2d_backward(tensor *, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
...
void atg_avg_pool2d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
void atg_avg_pool3d(tensor *, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
void atg_avg_pool3d_backward(tensor *, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
void atg_avg_pool3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
void atg_avg_pool3d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null);
...
void atg_bitwise_and_scalar_tensor(tensor *, scalar self, tensor other);
void atg_bitwise_and_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_bitwise_left_shift_scalar_tensor(tensor *, scalar self, tensor other);
void atg_bitwise_left_shift_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_bitwise_or_scalar_tensor(tensor *, scalar self, tensor other);
void atg_bitwise_or_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_bitwise_right_shift_scalar_tensor(tensor *, scalar self, tensor other);
void atg_bitwise_right_shift_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_bitwise_xor_scalar_tensor(tensor *, scalar self, tensor other);
void atg_bitwise_xor_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_bucketize_scalar(tensor *, scalar self, tensor boundaries, int out_int32, int right);
void atg_bucketize_scalar_out(tensor *, tensor out, scalar self, tensor boundaries, int out_int32, int right);
...
void atg_cdist(tensor *, tensor x1, tensor x2, double p, int64_t compute_mode_v, int compute_mode_null);
...
void atg_clone_out(tensor *, tensor out, tensor self);
...
void atg_conv1d_padding(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_conv2d_padding(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_conv3d_padding(tensor *, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups);
...
void atg_copy(tensor *, tensor self, tensor src, int non_blocking);
void atg_copy_out(tensor *, tensor out, tensor self, tensor src, int non_blocking);
...
void atg_count_nonzero(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len);
void atg_count_nonzero_out(tensor *, tensor out, tensor self, int64_t dim_v, int dim_null);
void atg_cov(tensor *, tensor self, int64_t correction, tensor fweights, tensor aweights);
void atg_cross(tensor *, tensor self, tensor other, int64_t dim_v, int dim_null);
...
void atg_cross_out(tensor *, tensor out, tensor self, tensor other, int64_t dim_v, int dim_null);
...
void atg_div_out_mode(tensor *, tensor out, tensor self, tensor other, char * rounding_mode);
void atg_div_scalar(tensor *, tensor self, scalar other);
void atg_div_scalar_(tensor *, tensor self, scalar other);
void atg_div_scalar_mode(tensor *, tensor self, scalar other, char * rounding_mode);
void atg_div_scalar_mode_(tensor *, tensor self, scalar other, char * rounding_mode);
void atg_div_scalar_mode_out(tensor *, tensor out, tensor self, scalar other, char * rounding_mode);
void atg_div_scalar_out(tensor *, tensor out, tensor self, scalar other);
void atg_div_tensor_mode(tensor *, tensor self, tensor other, char * rounding_mode);
void atg_div_tensor_mode_(tensor *, tensor self, tensor other, char * rounding_mode);
...
void atg_divide_out_mode(tensor *, tensor out, tensor self, tensor other, char * rounding_mode);
void atg_divide_scalar(tensor *, tensor self, scalar other);
void atg_divide_scalar_(tensor *, tensor self, scalar other);
void atg_divide_scalar_mode(tensor *, tensor self, scalar other, char * rounding_mode);
void atg_divide_scalar_mode_(tensor *, tensor self, scalar other, char * rounding_mode);
void atg_divide_tensor_mode(tensor *, tensor self, tensor other, char * rounding_mode);
void atg_divide_tensor_mode_(tensor *, tensor self, tensor other, char * rounding_mode);
...
void atg_einsum(tensor *, char * equation, tensor *tensors_data, int tensors_len, int64_t *path_data, int path_len);
...
void atg_embedding_bag_padding_idx(tensor *, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx_v, int padding_idx_null);
...
void atg_fft_fft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_fft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_fft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_fft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
...
void atg_fft_fftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_fftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_fftshift(tensor *, tensor self, int64_t *dim_data, int dim_len);
void atg_fft_hfft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_hfft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_hfft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_hfft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_hfftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_hfftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ifft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_ifft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ifft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ifft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_ifftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ifftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ifftshift(tensor *, tensor self, int64_t *dim_data, int dim_len);
void atg_fft_ihfft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_ihfft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ihfft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ihfft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_ihfftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_ihfftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_irfft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_irfft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_irfft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_irfft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_irfftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_irfftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_rfft(tensor *, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
void atg_fft_rfft2(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_rfft2_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_rfft_out(tensor *, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm);
...
void atg_fft_rfftn(tensor *, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
void atg_fft_rfftn_out(tensor *, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm);
...
void atg_float_power_scalar(tensor *, scalar self, tensor exponent);
void atg_float_power_scalar_out(tensor *, tensor out, scalar self, tensor exponent);
...
void atg_from_file(tensor *, char * filename, int shared, int64_t size_v, int size_null, int options_kind, int options_device);
void atg_from_file_out(tensor *, tensor out, char * filename, int shared, int64_t size_v, int size_null);
...
void atg_gelu(tensor *, tensor self, char * approximate);
void atg_gelu_(tensor *, tensor self, char * approximate);
void atg_gelu_backward(tensor *, tensor grad_output, tensor self, char * approximate);
void atg_gelu_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, char * approximate);
void atg_gelu_out(tensor *, tensor out, tensor self, char * approximate);
...
void atg_index_reduce(tensor *, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self);
void atg_index_reduce_(tensor *, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self);
void atg_index_reduce_out(tensor *, tensor out, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self);
...
void atg_istft(tensor *, tensor self, int64_t n_fft, int64_t hop_length_v, int hop_length_null, int64_t win_length_v, int win_length_null, tensor window, int center, int normalized, int onesided, int64_t length_v, int length_null, int return_complex);
...
void atg_linalg_cond_p_str(tensor *, tensor self, char * p);
void atg_linalg_cond_p_str_out(tensor *, tensor out, tensor self, char * p);
...
void atg_linalg_eigh(tensor *, tensor self, char * UPLO);
void atg_linalg_eigh_eigvals(tensor *, tensor eigvals, tensor eigvecs, tensor self, char * UPLO);
void atg_linalg_eigvals(tensor *, tensor self);
void atg_linalg_eigvals_out(tensor *, tensor out, tensor self);
void atg_linalg_eigvalsh(tensor *, tensor self, char * UPLO);
void atg_linalg_eigvalsh_out(tensor *, tensor out, tensor self, char * UPLO);
...
void atg_linalg_lstsq(tensor *, tensor self, tensor b, double rcond_v, int rcond_null, char * driver);
void atg_linalg_lstsq_out(tensor *, tensor solution, tensor residuals, tensor rank, tensor singular_values, tensor self, tensor b, double rcond_v, int rcond_null, char * driver);
...
void atg_linalg_matrix_rank_atol_rtol_float(tensor *, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian);
void atg_linalg_matrix_rank_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian);
...
void atg_linalg_pinv_atol_rtol_float(tensor *, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian);
void atg_linalg_pinv_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian);
...
void atg_linalg_qr(tensor *, tensor A, char * mode);
void atg_linalg_qr_out(tensor *, tensor Q, tensor R, tensor A, char * mode);
...
void atg_linalg_svd(tensor *, tensor A, int full_matrices, char * driver);
void atg_linalg_svd_u(tensor *, tensor U, tensor S, tensor Vh, tensor A, int full_matrices, char * driver);
void atg_linalg_svdvals(tensor *, tensor A, char * driver);
void atg_linalg_svdvals_out(tensor *, tensor out, tensor A, char * driver);
...
void atg_linalg_vander(tensor *, tensor x, int64_t n_v, int n_null);
...
void atg_logit(tensor *, tensor self, double eps_v, int eps_null);
void atg_logit_(tensor *, tensor self, double eps_v, int eps_null);
void atg_logit_backward(tensor *, tensor grad_output, tensor self, double eps_v, int eps_null);
void atg_logit_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, double eps_v, int eps_null);
void atg_logit_out(tensor *, tensor out, tensor self, double eps_v, int eps_null);
...
void atg_nan_to_num(tensor *, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null);
void atg_nan_to_num_(tensor *, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null);
void atg_nan_to_num_out(tensor *, tensor out, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null);
...
void atg_nanquantile(tensor *, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
...
void atg_nanquantile_scalar(tensor *, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
void atg_nanquantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
...
void atg_pad(tensor *, tensor self, int64_t *pad_data, int pad_len, char * mode, double value_v, int value_null);
...
void atg_pow_scalar(tensor *, scalar self, tensor exponent);
void atg_pow_scalar_out(tensor *, tensor out, scalar self, tensor exponent);
...
void atg_quantile(tensor *, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
void atg_quantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
void atg_quantile_scalar(tensor *, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
void atg_quantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation);
...
void atg_random_from(tensor *, tensor self, int64_t from, int64_t to_v, int to_null);
void atg_random_from_(tensor *, tensor self, int64_t from, int64_t to_v, int to_null);
void atg_random_from_out(tensor *, tensor out, tensor self, int64_t from, int64_t to_v, int to_null);
...
void atg_remainder_scalar_tensor(tensor *, scalar self, tensor other);
void atg_remainder_scalar_tensor_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_repeat_interleave(tensor *, tensor repeats, int64_t output_size_v, int output_size_null);
void atg_repeat_interleave_self_int(tensor *, tensor self, int64_t repeats, int64_t dim_v, int dim_null, int64_t output_size_v, int output_size_null);
void atg_repeat_interleave_self_tensor(tensor *, tensor self, tensor repeats, int64_t dim_v, int dim_null, int64_t output_size_v, int output_size_null);
void atg_repeat_interleave_tensor_out(tensor *, tensor out, tensor repeats, int64_t output_size_v, int output_size_null);
...
void atg_scaled_dot_product_attention(tensor *, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, double scale_v, int scale_null);
...
void atg_scatter_reduce(tensor *, tensor self, int64_t dim, tensor index, tensor src, char * reduce);
void atg_scatter_reduce_(tensor *, tensor self, int64_t dim, tensor index, tensor src, char * reduce);
void atg_scatter_reduce_out(tensor *, tensor out, tensor self, int64_t dim, tensor index, tensor src, char * reduce);
...
void atg_scatter_value_reduce(tensor *, tensor self, int64_t dim, tensor index, scalar value, char * reduce);
void atg_scatter_value_reduce_(tensor *, tensor self, int64_t dim, tensor index, scalar value, char * reduce);
void atg_scatter_value_reduce_out(tensor *, tensor out, tensor self, int64_t dim, tensor index, scalar value, char * reduce);
void atg_searchsorted(tensor *, tensor sorted_sequence, tensor self, int out_int32, int right, char * side, tensor sorter);
void atg_searchsorted_scalar(tensor *, tensor sorted_sequence, scalar self, int out_int32, int right, char * side, tensor sorter);
void atg_searchsorted_scalar_out(tensor *, tensor out, tensor sorted_sequence, scalar self, int out_int32, int right, char * side, tensor sorter);
void atg_searchsorted_tensor_out(tensor *, tensor out, tensor sorted_sequence, tensor self, int out_int32, int right, char * side, tensor sorter);
void atg_segment_reduce(tensor *, tensor data, char * reduce, tensor lengths, tensor indices, tensor offsets, int64_t axis, int unsafe, scalar initial);
...
void atg_slice(tensor *, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step);
...
void atg_slice_copy(tensor *, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step);
void atg_slice_copy_tensor_out(tensor *, tensor out, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step);
void atg_slice_scatter(tensor *, tensor self, tensor src, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step);
void atg_slice_scatter_out(tensor *, tensor out, tensor self, tensor src, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step);
...
void atg_special_logit(tensor *, tensor self, double eps_v, int eps_null);
void atg_special_logit_out(tensor *, tensor out, tensor self, double eps_v, int eps_null);
...
void atg_special_xlog1py_self_scalar(tensor *, scalar self, tensor other);
void atg_special_xlog1py_self_scalar_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_special_xlogy_self_scalar(tensor *, scalar self, tensor other);
void atg_special_xlogy_self_scalar_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_special_zeta_self_scalar(tensor *, scalar self, tensor other);
void atg_special_zeta_self_scalar_out(tensor *, tensor out, scalar self, tensor other);
...
void atg_stft(tensor *, tensor self, int64_t n_fft, int64_t hop_length_v, int hop_length_null, int64_t win_length_v, int win_length_null, tensor window, int normalized, int onesided, int return_complex);
...
void atg_take_along_dim(tensor *, tensor self, tensor indices, int64_t dim_v, int dim_null);
void atg_take_along_dim_out(tensor *, tensor out, tensor self, tensor indices, int64_t dim_v, int dim_null);
...
void atg_unique_consecutive(tensor *, tensor self, int return_inverse, int return_counts, int64_t dim_v, int dim_null);
void atg_unique_consecutive_out(tensor *, tensor out0, tensor out1, tensor out2, tensor self, int return_inverse, int return_counts, int64_t dim_v, int dim_null);
...
void atg_upsample_bicubic2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bicubic2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bicubic2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bicubic2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_upsample_bilinear2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bilinear2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bilinear2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_bilinear2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_upsample_linear1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int scales_null);
void atg_upsample_linear1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int scales_null);
void atg_upsample_linear1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int scales_null);
void atg_upsample_linear1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int scales_null);
...
void atg_upsample_nearest1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null);
void atg_upsample_nearest1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null);
void atg_upsample_nearest1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null);
void atg_upsample_nearest1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null);
...
void atg_upsample_nearest2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_upsample_nearest3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_nearest3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_upsample_trilinear3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
void atg_upsample_trilinear3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_upsample_trilinear3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null);
...
void atg_vander(tensor *, tensor x, int64_t n_v, int n_null, int increasing);
...
void atg_where_scalar(tensor *, tensor condition, scalar self, scalar other);
void atg_where_scalarother(tensor *, tensor condition, tensor self, scalar other);
void atg_where_scalarself(tensor *, tensor condition, scalar self, tensor other);
...
void atg_xlogy_outscalar_self(tensor *, tensor out, scalar self, tensor other);
...
void atg_xlogy_scalar_self(tensor *, scalar self, tensor other);
