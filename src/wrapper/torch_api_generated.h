...
void atg__linalg_eigh(raw_tensor *, gc_tensor A, const char * UPLO, int compute_v);
void atg__linalg_eigh_eigenvalues(raw_tensor *, gc_tensor eigenvalues, gc_tensor eigenvectors, gc_tensor A, const char * UPLO, int compute_v);
...
void atg__scaled_dot_product_attention_math(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value_, gc_tensor attn_mask, double dropout_p, int is_causal, gc_tensor dropout_mask, double scale_v, int scale_null, int enable_gqa);
void atg__scaled_dot_product_attention_math_for_mps(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value_, gc_tensor attn_mask, double dropout_p, int is_causal, gc_tensor dropout_mask, double scale_v, int scale_null);
...
void atg__scaled_dot_product_efficient_attention(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value_, gc_tensor attn_bias, int compute_log_sumexp, double dropout_p, int is_causal, double scale_v, int scale_null);
...
void atg__scaled_dot_product_flash_attention_for_cpu(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value_, double dropout_p, int is_causal, gc_tensor attn_mask, double scale_v, int scale_null);
void atg__scaled_dot_product_flash_attention_for_cpu_backward(raw_tensor *, gc_tensor grad_out, gc_tensor query, gc_tensor key, gc_tensor value_, gc_tensor out, gc_tensor logsumexp, double dropout_p, int is_causal, gc_tensor attn_mask, double scale_v, int scale_null);
...
void atg__sparse_mm_reduce_impl(raw_tensor *, gc_tensor self, gc_tensor other, const char * reduce);
...
void atg__sparse_semi_structured_tile(raw_tensor *, gc_tensor input, const char * algorithm, int use_cutlass);
...
void atg_linalg_eigh(raw_tensor *, gc_tensor self, const char * UPLO);
void atg_linalg_eigh_eigvals(raw_tensor *, gc_tensor eigvals, gc_tensor eigvecs, gc_tensor self, const char * UPLO);
...
void atg_linalg_qr(raw_tensor *, gc_tensor A, const char * mode);
void atg_linalg_qr_out(raw_tensor *, gc_tensor Q, gc_tensor R, gc_tensor A, const char * mode);
...
void atg_rrelu_with_noise_functional(raw_tensor *, gc_tensor self, gc_tensor noise, scalar lower, scalar upper, int training);
