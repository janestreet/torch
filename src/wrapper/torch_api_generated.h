...
void atg__linalg_svd(raw_tensor *, gc_tensor A, int full_matrices, int compute_uv, char * driver);
void atg__linalg_svd_u(raw_tensor *, gc_tensor U, gc_tensor S, gc_tensor Vh, gc_tensor A, int full_matrices, int compute_uv, char * driver);
...
void atg__scaled_mm(raw_tensor *, gc_tensor self, gc_tensor mat2, gc_tensor bias, int out_dtype, gc_tensor scale_a, gc_tensor scale_b, gc_tensor scale_result);
void atg__scaled_mm_out(raw_tensor *, gc_tensor out, gc_tensor out_amax, gc_tensor self, gc_tensor mat2, gc_tensor bias, int out_dtype, gc_tensor scale_a, gc_tensor scale_b, gc_tensor scale_result);
...
void atg_linalg_lstsq(raw_tensor *, gc_tensor self, gc_tensor b, double rcond_v, int rcond_null, char * driver);
void atg_linalg_lstsq_out(raw_tensor *, gc_tensor solution, gc_tensor residuals, gc_tensor rank, gc_tensor singular_values, gc_tensor self, gc_tensor b, double rcond_v, int rcond_null, char * driver);
...
void atg_linalg_svd(raw_tensor *, gc_tensor A, int full_matrices, char * driver);
void atg_linalg_svd_u(raw_tensor *, gc_tensor U, gc_tensor S, gc_tensor Vh, gc_tensor A, int full_matrices, char * driver);
