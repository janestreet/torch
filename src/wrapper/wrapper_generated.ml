...
let _cholesky_solve_helper_out ~out self ~a ~upper =
  let out__ = CArray.make t 1 in
  stubs__cholesky_solve_helper_out
    (CArray.start out__)
    out
    self
    a
...
let _flash_scaled_dot_product_attention
  ~query
  ~key
  ~value
  ~cum_seq_q
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__flash_scaled_dot_product_attention
    (CArray.start out__)
    query
    key
    value
...
let _fused_adam
  ...
  stubs__fused_adam
    ...
    (List.length out)
    (CArray.of_list t self |> CArray.start)
    (List.length self)
    (CArray.of_list t grads |> CArray.start)
    (List.length grads)
    (CArray.of_list t exp_avgs |> CArray.start)
    (List.length exp_avgs)
    (CArray.of_list t exp_avg_sqs |> CArray.start)
    (List.length exp_avg_sqs)
    (CArray.of_list t max_exp_avg_sqs |> CArray.start)
    (List.length max_exp_avg_sqs)
    (CArray.of_list t state_steps |> CArray.start)
...
let _histogramdd_from_bin_tensors self ~bins ~weight ~density =
  ...
  stubs__histogramdd_from_bin_tensors
    (CArray.start out__)
    self
    (CArray.of_list t bins |> CArray.start)
    (List.length bins)
    (match weight with
     | Some v -> v
     | None -> null)
...
let _make_per_tensor_quantized_tensor_out ~out self ~scale ~zero_point =
  let out__ = CArray.make t 1 in
  stubs__make_per_tensor_quantized_tensor_out
    (CArray.start out__)
    out
    self
    scale
...
let _native_decoder_only_multi_head_attention
  ~query
  ~key
  ~value
  ~embed_dim
  ...
  =
  let out__ = CArray.make t 4 in
  stubs__native_decoder_only_multi_head_attention
    (CArray.start out__)
    query
    key
    value
...
let _native_decoder_only_multi_head_attention_out
  ~out0
  ~out1
  ~out2
  ~out3
  ...
  =
  let out__ = CArray.make t 4 in
  stubs__native_decoder_only_multi_head_attention_out
    (CArray.start out__)
    out0
    out1
    out2
...
let _nested_from_padded_and_nested_example_out ~out ~padded ~nt_example =
  let out__ = CArray.make t 1 in
  stubs__nested_from_padded_and_nested_example_out
    (CArray.start out__)
    out
    padded
    nt_example;
...
let _nested_view_from_buffer self ~nested_size ~nested_strides ~offsets =
  let out__ = CArray.make t 1 in
  stubs__nested_view_from_buffer
    (CArray.start out__)
    self
    nested_size
    nested_strides
    (List.map Int64.of_int offsets |> CArray.of_list int64_t |> CArray.start)
    (List.length offsets);
  let t0 = CArray.get out__ 0 in
  Gc.finalise C.Tensor.free t0;
  t0
...
let _nested_view_from_buffer_copy self ~nested_size ~nested_strides ~offsets =
  let out__ = CArray.make t 1 in
  stubs__nested_view_from_buffer_copy
    (CArray.start out__)
    self
    nested_size
    nested_strides
...
let _nested_view_from_buffer_copy_out ~out self ~nested_size ~nested_strides ~offsets =
  let out__ = CArray.make t 1 in
  stubs__nested_view_from_buffer_copy_out
    (CArray.start out__)
    out
    self
    nested_size
...
let _new_zeros_with_same_feature_meta self other ~self_num_batch_dims =
  let out__ = CArray.make t 1 in
  stubs__new_zeros_with_same_feature_meta
    (CArray.start out__)
    self
    other
...
let _scaled_dot_product_attention
  ~query
  ~key
  ~value
  ~attn_mask
  ...
  =
  let out__ = CArray.make t 2 in
  stubs__scaled_dot_product_attention
    (CArray.start out__)
    query
    key
    value
    (match attn_mask with
     ...
     | None -> null)
    dropout_p
    (if need_attn_weights then 1 else 0)
    (if is_causal then 1 else 0);
  let t0 = CArray.get out__ 0 in
  Gc.finalise C.Tensor.free t0;
  let t1 = CArray.get out__ 1 in
...
let _sparse_softmax_backward_data_out ~out ~grad_output ~output ~dim self =
  let out__ = CArray.make t 1 in
  stubs__sparse_softmax_backward_data_out
    (CArray.start out__)
    out
    grad_output
    output
...
let _test_autograd_multiple_dispatch_ntonly self ~b =
  let out__ = CArray.make t 1 in
  stubs__test_autograd_multiple_dispatch_ntonly
    (CArray.start out__)
    self
    (if b then 1 else 0);
  let t0 = CArray.get out__ 0 in
...
let _to_cpu tensors =
  stubs__to_cpu (CArray.of_list t tensors |> CArray.start) (List.length tensors)
  |> to_tensor_list
;;
...
let _transformer_decoder_only_layer_fwd
  ~src
  ~embed_dim
  ~num_heads
  ~qkv_weight
  ...
  =
  let out__ = CArray.make t 3 in
  stubs__transformer_decoder_only_layer_fwd
    (CArray.start out__)
    src
    (Int64.of_int embed_dim)
    (Int64.of_int num_heads)
...
let _transformer_decoder_only_layer_fwd_out
  ~out0
  ~out1
  ~out2
  ~src
  ...
  =
  let out__ = CArray.make t 3 in
  stubs__transformer_decoder_only_layer_fwd_out
    (CArray.start out__)
    out0
    out1
    out2
...
let _upsample_bicubic2d_aa_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_bicubic2d_aa_backward_vec
    (CArray.start out__)
    grad_output
...
let _upsample_bicubic2d_aa_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_bicubic2d_aa_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let _upsample_bicubic2d_aa_vec_out ~out input ~output_size ~align_corners ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs__upsample_bicubic2d_aa_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let _upsample_bilinear2d_aa_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_bilinear2d_aa_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let _upsample_bilinear2d_aa_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_bilinear2d_aa_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let _upsample_bilinear2d_aa_vec_out ~out input ~output_size ~align_corners ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs__upsample_bilinear2d_aa_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let _upsample_nearest_exact1d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~scale_factors
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_nearest_exact1d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let _upsample_nearest_exact1d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs__upsample_nearest_exact1d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let _upsample_nearest_exact2d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~scale_factors
...
let _upsample_nearest_exact2d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
...
let _upsample_nearest_exact3d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~scale_factors
...
let _upsample_nearest_exact3d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
...
let _upsample_nearest_exact3d_vec_out ~out input ~output_size ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs__upsample_nearest_exact3d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let copy_sparse_to_sparse_out ~out self ~src ~non_blocking =
  let out__ = CArray.make t 1 in
  stubs_copy_sparse_to_sparse_out
    (CArray.start out__)
    out
    self
    src
...
let gelu_backward_grad_input ~grad_input ~grad_output self ~approximate =
  let out__ = CArray.make t 1 in
  stubs_gelu_backward_grad_input
    (CArray.start out__)
    grad_input
    grad_output
    self
...
let index_fill_int_scalar_out ~out self ~dim ~index ~value =
  let out__ = CArray.make t 1 in
  stubs_index_fill_int_scalar_out
    (CArray.start out__)
    out
    self
    (Int64.of_int dim)
...
let index_fill_int_tensor_out ~out self ~dim ~index ~value =
  let out__ = CArray.make t 1 in
  stubs_index_fill_int_tensor_out
    (CArray.start out__)
    out
    self
    (Int64.of_int dim)
...
let lstm_mps_backward
  ...
  stubs_lstm_mps_backward
    out0
    (CArray.of_list t out1 |> CArray.start)
    (List.length out1)
    (CArray.of_list t out2 |> CArray.start)
    (List.length out2)
    grad_y
    (match grad_hy with
     | Some v -> v
...
let mps_max_pool2d_backward_out
  ~out
  ~grad_output
  self
  ~kernel_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_mps_max_pool2d_backward_out
    (CArray.start out__)
    out
    grad_output
    self
...
let norm_scalaropt_dtype_out ~out self ~p ~dtype =
  let out__ = CArray.make t 1 in
  stubs_norm_scalaropt_dtype_out
    (CArray.start out__)
    out
    self
    p
...
let randint_like_low_dtype_out ~out self ~low ~high =
  let out__ = CArray.make t 1 in
  stubs_randint_like_low_dtype_out
    (CArray.start out__)
    out
    self
    (Int64.of_int low)
...
let scatter_value_reduce_out ~out self ~dim ~index ~value ~reduce =
  let out__ = CArray.make t 1 in
  stubs_scatter_value_reduce_out
    (CArray.start out__)
    out
    self
    (Int64.of_int dim)
...
let upsample_bicubic2d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_bicubic2d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_bicubic2d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_bicubic2d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let upsample_bicubic2d_vec_out ~out input ~output_size ~align_corners ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_bicubic2d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let upsample_bilinear2d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_bilinear2d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_bilinear2d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_bilinear2d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let upsample_linear1d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_linear1d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_linear1d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
...
let upsample_linear1d_vec_out ~out input ~output_size ~align_corners ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_linear1d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let upsample_nearest1d_backward_vec ~grad_output ~output_size ~input_size ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest1d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_nearest1d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest1d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let upsample_nearest1d_vec_out ~out input ~output_size ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest1d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let upsample_nearest2d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest2d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let upsample_nearest3d_backward_vec ~grad_output ~output_size ~input_size ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest3d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_nearest3d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
...
let upsample_nearest3d_vec_out ~out input ~output_size ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_nearest3d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
...
let upsample_trilinear3d_backward_vec
  ~grad_output
  ~output_size
  ~input_size
  ~align_corners
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_trilinear3d_backward_vec
    (CArray.start out__)
    grad_output
    (match output_size with
     | None -> from_voidp int64_t null
...
let upsample_trilinear3d_backward_vec_out
  ~out
  ~grad_output
  ~output_size
  ~input_size
  ...
  =
  let out__ = CArray.make t 1 in
  stubs_upsample_trilinear3d_backward_vec_out
    (CArray.start out__)
    out
    grad_output
    (match output_size with
...
let upsample_trilinear3d_vec_out ~out input ~output_size ~align_corners ~scale_factors =
  let out__ = CArray.make t 1 in
  stubs_upsample_trilinear3d_vec_out
    (CArray.start out__)
    out
    input
    (match output_size with
