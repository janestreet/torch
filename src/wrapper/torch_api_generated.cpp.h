...
void atg__assert_tensor_metadata(tensor a, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int dtype) {
  PROTECT(
    torch::_assert_tensor_metadata(*a, size_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(size_data, size_len)), stride_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(stride_data, stride_len)), torch::ScalarType(dtype));
  )
}
...
void atg__autocast_to_reduced_precision(tensor *out__, tensor self, int cuda_enabled, int cpu_enabled, int cuda_dtype, int cpu_dtype) {
  PROTECT(
    auto outputs__ = self->_autocast_to_reduced_precision((bool)cuda_enabled, (bool)cpu_enabled, torch::ScalarType(cuda_dtype), torch::ScalarType(cpu_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__convolution_mode(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
    auto outputs__ = torch::_convolution_mode(*input, *weight, (bias ? *bias : torch::Tensor()), torch::IntArrayRef(stride_data, stride_len), std::string(padding), torch::IntArrayRef(dilation_data, dilation_len), groups);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__efficient_attention_backward(tensor *out__, tensor grad_out_, tensor query, tensor key, tensor value, tensor bias, tensor out, tensor cu_seqlens_q, tensor cu_seqlens_k, int64_t max_seqlen_k, int64_t max_seqlen_q, tensor logsumexp, double dropout_p, tensor philox_seed, tensor philox_offset, int64_t custom_mask_type, int bias_requires_grad, double scale_v, int scale_null, int64_t num_splits_key_v, int num_splits_key_null) {
  PROTECT(
...
void atg__flash_attention_backward(tensor *out__, tensor grad_out, tensor query, tensor key, tensor value, tensor out, tensor logsumexp, tensor cum_seq_q, tensor cum_seq_k, int64_t max_q, int64_t max_k, double dropout_p, int is_causal, tensor philox_seed, tensor philox_offset, double scale_v, int scale_null) {
  PROTECT(
...
void atg__functional_assert_async(tensor *out__, tensor self, char * assert_msg, tensor dep_token) {
  PROTECT(
    auto outputs__ = torch::_functional_assert_async(*self, std::string(assert_msg), *dep_token);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__functional_sym_constrain_range(tensor *out__, scalar size, int64_t min_v, int min_null, int64_t max_v, int max_null, tensor dep_token) {
  PROTECT(
...
void atg__functional_sym_constrain_range_for_size(tensor *out__, scalar size, int64_t min_v, int min_null, int64_t max_v, int max_null, tensor dep_token) {
  PROTECT(
...
void atg__fused_adam(tensor *out_data, int out_len, tensor *self_data, int self_len, tensor *grads_data, int grads_len, tensor *exp_avgs_data, int exp_avgs_len, tensor *exp_avg_sqs_data, int exp_avg_sqs_len, tensor *max_exp_avg_sqs_data, int max_exp_avg_sqs_len, tensor *state_steps_data, int state_steps_len, double lr, double beta1, double beta2, double weight_decay, double eps, int amsgrad, int maximize, tensor grad_scale, tensor found_inf) {
  PROTECT(
    torch::_fused_adam_out(of_carray_tensor(out_data, out_len), of_carray_tensor(self_data, self_len), of_carray_tensor(grads_data, grads_len), of_carray_tensor(exp_avgs_data, exp_avgs_len), of_carray_tensor(exp_avg_sqs_data, exp_avg_sqs_len), of_carray_tensor(max_exp_avg_sqs_data, max_exp_avg_sqs_len), of_carray_tensor(state_steps_data, state_steps_len), lr, beta1, beta2, weight_decay, eps, (bool)amsgrad, (bool)maximize, (grad_scale ? *grad_scale : torch::Tensor()), (found_inf ? *found_inf : torch::Tensor()));
  )
}
...
void atg__fused_adam_(tensor *self_data, int self_len, tensor *grads_data, int grads_len, tensor *exp_avgs_data, int exp_avgs_len, tensor *exp_avg_sqs_data, int exp_avg_sqs_len, tensor *max_exp_avg_sqs_data, int max_exp_avg_sqs_len, tensor *state_steps_data, int state_steps_len, double lr, double beta1, double beta2, double weight_decay, double eps, int amsgrad, int maximize, tensor grad_scale, tensor found_inf) {
  PROTECT(
    torch::_fused_adam_(of_carray_tensor(self_data, self_len), of_carray_tensor(grads_data, grads_len), of_carray_tensor(exp_avgs_data, exp_avgs_len), of_carray_tensor(exp_avg_sqs_data, exp_avg_sqs_len), of_carray_tensor(max_exp_avg_sqs_data, max_exp_avg_sqs_len), of_carray_tensor(state_steps_data, state_steps_len), lr, beta1, beta2, weight_decay, eps, (bool)amsgrad, (bool)maximize, (grad_scale ? *grad_scale : torch::Tensor()), (found_inf ? *found_inf : torch::Tensor()));
  )
}
...
void atg__fused_adamw(tensor *out_data, int out_len, tensor *self_data, int self_len, tensor *grads_data, int grads_len, tensor *exp_avgs_data, int exp_avgs_len, tensor *exp_avg_sqs_data, int exp_avg_sqs_len, tensor *max_exp_avg_sqs_data, int max_exp_avg_sqs_len, tensor *state_steps_data, int state_steps_len, double lr, double beta1, double beta2, double weight_decay, double eps, int amsgrad, int maximize, tensor grad_scale, tensor found_inf) {
  PROTECT(
    torch::_fused_adamw_out(of_carray_tensor(out_data, out_len), of_carray_tensor(self_data, self_len), of_carray_tensor(grads_data, grads_len), of_carray_tensor(exp_avgs_data, exp_avgs_len), of_carray_tensor(exp_avg_sqs_data, exp_avg_sqs_len), of_carray_tensor(max_exp_avg_sqs_data, max_exp_avg_sqs_len), of_carray_tensor(state_steps_data, state_steps_len), lr, beta1, beta2, weight_decay, eps, (bool)amsgrad, (bool)maximize, (grad_scale ? *grad_scale : torch::Tensor()), (found_inf ? *found_inf : torch::Tensor()));
  )
}
...
void atg__fused_adamw_(tensor *self_data, int self_len, tensor *grads_data, int grads_len, tensor *exp_avgs_data, int exp_avgs_len, tensor *exp_avg_sqs_data, int exp_avg_sqs_len, tensor *max_exp_avg_sqs_data, int max_exp_avg_sqs_len, tensor *state_steps_data, int state_steps_len, double lr, double beta1, double beta2, double weight_decay, double eps, int amsgrad, int maximize, tensor grad_scale, tensor found_inf) {
  PROTECT(
    torch::_fused_adamw_(of_carray_tensor(self_data, self_len), of_carray_tensor(grads_data, grads_len), of_carray_tensor(exp_avgs_data, exp_avgs_len), of_carray_tensor(exp_avg_sqs_data, exp_avg_sqs_len), of_carray_tensor(max_exp_avg_sqs_data, max_exp_avg_sqs_len), of_carray_tensor(state_steps_data, state_steps_len), lr, beta1, beta2, weight_decay, eps, (bool)amsgrad, (bool)maximize, (grad_scale ? *grad_scale : torch::Tensor()), (found_inf ? *found_inf : torch::Tensor()));
  )
}
...
int64_t atg__fused_sdp_choice(tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, double scale_v, int scale_null) {
  PROTECT(
...
void atg__linalg_check_errors(tensor info, char * api_name, int is_matrix) {
  PROTECT(
    torch::_linalg_check_errors(*info, std::string(api_name), (bool)is_matrix);
  )
}
...
void atg__linalg_eigh(tensor *out__, tensor A, char * UPLO, int compute_v) {
  PROTECT(
    auto outputs__ = torch::_linalg_eigh(*A, std::string(UPLO), (bool)compute_v);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg__linalg_eigh_eigenvalues(tensor *out__, tensor eigenvalues, tensor eigenvectors, tensor A, char * UPLO, int compute_v) {
  PROTECT(
    auto outputs__ = torch::_linalg_eigh_out(*eigenvalues, *eigenvectors, *A, std::string(UPLO), (bool)compute_v);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__linalg_svd(tensor *out__, tensor A, int full_matrices, int compute_uv, char * driver) {
  PROTECT(
    auto outputs__ = torch::_linalg_svd(*A, (bool)full_matrices, (bool)compute_uv, std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__linalg_svd_u(tensor *out__, tensor U, tensor S, tensor Vh, tensor A, int full_matrices, int compute_uv, char * driver) {
  PROTECT(
    auto outputs__ = torch::_linalg_svd_out(*U, *S, *Vh, *A, (bool)full_matrices, (bool)compute_uv, std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__log_softmax_backward_data(tensor *out__, tensor grad_output, tensor output, int64_t dim, int input_dtype) {
  PROTECT(
    auto outputs__ = torch::_log_softmax_backward_data(*grad_output, *output, dim, torch::ScalarType(input_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__log_softmax_backward_data_out(tensor *out__, tensor out, tensor grad_output, tensor output, int64_t dim, int input_dtype) {
  PROTECT(
    auto outputs__ = torch::_log_softmax_backward_data_out(*out, *grad_output, *output, dim, torch::ScalarType(input_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__masked_softmax(tensor *out__, tensor self, tensor mask, int64_t dim_v, int dim_null, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__masked_softmax_backward(tensor *out__, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg__masked_softmax_backward_out(tensor *out__, tensor out, tensor grad_output, tensor output, tensor mask, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg__masked_softmax_out(tensor *out__, tensor out, tensor self, tensor mask, int64_t dim_v, int dim_null, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__native_multi_head_attention(tensor *out__, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__native_multi_head_attention_out(tensor *out__, tensor out0, tensor out1, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__pad_enum(tensor *out__, tensor self, int64_t *pad_data, int pad_len, int64_t mode, double value_v, int value_null) {
  PROTECT(
...
void atg__rowwise_prune(tensor *out__, tensor weight, tensor mask, int compressed_indices_dtype) {
  PROTECT(
    auto outputs__ = torch::_rowwise_prune(*weight, *mask, torch::ScalarType(compressed_indices_dtype));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__scaled_dot_product_attention_math(tensor *out__, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, tensor dropout_mask, double scale_v, int scale_null) {
  PROTECT(
...
void atg__scaled_dot_product_efficient_attention(tensor *out__, tensor query, tensor key, tensor value, tensor attn_bias, int compute_log_sumexp, double dropout_p, int is_causal, double scale_v, int scale_null) {
  PROTECT(
...
void atg__scaled_mm(tensor *out__, tensor self, tensor mat2, tensor bias, int out_dtype, tensor scale_a, tensor scale_b, tensor scale_result) {
  PROTECT(
    auto outputs__ = torch::_scaled_mm(*self, *mat2, (bias ? *bias : torch::Tensor()), torch::ScalarType(out_dtype), (scale_a ? *scale_a : torch::Tensor()), (scale_b ? *scale_b : torch::Tensor()), (scale_result ? *scale_result : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__scaled_mm_out(tensor *out__, tensor out, tensor out_amax, tensor self, tensor mat2, tensor bias, int out_dtype, tensor scale_a, tensor scale_b, tensor scale_result) {
  PROTECT(
    auto outputs__ = torch::_scaled_mm_out(*out, *out_amax, *self, *mat2, (bias ? *bias : torch::Tensor()), torch::ScalarType(out_dtype), (scale_a ? *scale_a : torch::Tensor()), (scale_b ? *scale_b : torch::Tensor()), (scale_result ? *scale_result : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg__scatter_reduce(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = torch::scatter_reduce(*self, dim, *index, *src, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__scatter_reduce_(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = self->scatter_reduce_(dim, *index, *src, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__scatter_reduce_two_out(tensor *out__, tensor out, tensor self, int64_t dim, tensor index, tensor src, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = torch::scatter_reduce_out(*out, *self, dim, *index, *src, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__segment_reduce_backward(tensor *out__, tensor grad, tensor output, tensor data, char * reduce, tensor lengths, tensor offsets, int64_t axis, scalar initial) {
  PROTECT(
    auto outputs__ = torch::_segment_reduce_backward(*grad, *output, *data, std::string(reduce), (lengths ? *lengths : torch::Tensor()), (offsets ? *offsets : torch::Tensor()), axis, *initial);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__segment_reduce_backward_out(tensor *out__, tensor out, tensor grad, tensor output, tensor data, char * reduce, tensor lengths, tensor offsets, int64_t axis, scalar initial) {
  PROTECT(
    auto outputs__ = torch::_segment_reduce_backward_out(*out, *grad, *output, *data, std::string(reduce), (lengths ? *lengths : torch::Tensor()), (offsets ? *offsets : torch::Tensor()), axis, *initial);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sobol_engine_draw(tensor *out__, tensor quasi, int64_t n, tensor sobolstate, int64_t dimension, int64_t num_generated, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sobol_engine_draw(*quasi, n, *sobolstate, dimension, num_generated, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg__softmax_backward_data(tensor *out__, tensor grad_output, tensor output, int64_t dim, int input_dtype) {
  PROTECT(
    auto outputs__ = torch::_softmax_backward_data(*grad_output, *output, dim, torch::ScalarType(input_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__softmax_backward_data_out(tensor *out__, tensor grad_input, tensor grad_output, tensor output, int64_t dim, int input_dtype) {
  PROTECT(
    auto outputs__ = torch::_softmax_backward_data_out(*grad_input, *grad_output, *output, dim, torch::ScalarType(input_dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_csr_prod(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_prod(*self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_csr_prod_dim_dtype_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_prod_out(*out, *self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_csr_sum(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_sum(*self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_csr_sum_dim_dtype_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_sum_out(*out, *self, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_log_softmax_int(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_log_softmax(*self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_mm_reduce(tensor *out__, tensor sparse, tensor dense, char * reduce) {
  PROTECT(
    auto outputs__ = torch::_sparse_mm(*sparse, *dense, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__sparse_mm_reduce_impl(tensor *out__, tensor self, tensor other, char * reduce) {
  PROTECT(
    auto outputs__ = torch::_sparse_mm_reduce_impl(*self, *other, std::string(reduce));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg__sparse_semi_structured_linear(tensor *out__, tensor input, tensor weight, tensor meta, tensor bias, char * activation) {
  PROTECT(
    auto outputs__ = torch::_sparse_semi_structured_linear(*input, *weight, *meta, (bias ? *bias : torch::Tensor()), std::string(activation));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_softmax_int(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_softmax(*self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_sum_dim_dtype(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_sum(*self, torch::IntArrayRef(dim_data, dim_len), torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_sum_dtype(tensor *out__, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::_sparse_sum(*self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__test_ambiguous_defaults_b(tensor *out__, tensor dummy, int64_t a, char * b) {
  PROTECT(
    auto outputs__ = torch::_test_ambiguous_defaults(*dummy, a, std::string(b));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__test_string_default(tensor *out__, tensor dummy, char * a, char * b) {
  PROTECT(
    auto outputs__ = torch::_test_string_default(*dummy, std::string(a), std::string(b));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__thnn_differentiable_gru_cell_backward(tensor *out__, tensor grad_hy, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_differentiable_gru_cell_backward(*grad_hy, *input_gates, *hidden_gates, *hx, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg__thnn_differentiable_lstm_cell_backward(tensor *out__, tensor grad_hy, tensor grad_cy, tensor input_gates, tensor hidden_gates, tensor input_bias, tensor hidden_bias, tensor cx, tensor cy) {
  PROTECT(
    auto outputs__ = torch::_thnn_differentiable_lstm_cell_backward((grad_hy ? *grad_hy : torch::Tensor()), (grad_cy ? *grad_cy : torch::Tensor()), *input_gates, *hidden_gates, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()), *cx, *cy);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg__thnn_fused_gru_cell(tensor *out__, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_gru_cell(*input_gates, *hidden_gates, *hx, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg__thnn_fused_gru_cell_backward(tensor *out__, tensor grad_hy, tensor workspace, int has_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_gru_cell_backward(*grad_hy, *workspace, (bool)has_bias);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg__thnn_fused_gru_cell_backward_out(tensor *out__, tensor out0, tensor out1, tensor out2, tensor out3, tensor out4, tensor grad_hy, tensor workspace, int has_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_gru_cell_backward_out(*out0, *out1, *out2, *out3, *out4, *grad_hy, *workspace, (bool)has_bias);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg__thnn_fused_gru_cell_out(tensor *out__, tensor out0, tensor out1, tensor input_gates, tensor hidden_gates, tensor hx, tensor input_bias, tensor hidden_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_gru_cell_out(*out0, *out1, *input_gates, *hidden_gates, *hx, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg__thnn_fused_lstm_cell(tensor *out__, tensor input_gates, tensor hidden_gates, tensor cx, tensor input_bias, tensor hidden_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_lstm_cell(*input_gates, *hidden_gates, *cx, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__thnn_fused_lstm_cell_backward(tensor *out__, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_lstm_cell_backward((grad_hy ? *grad_hy : torch::Tensor()), (grad_cy ? *grad_cy : torch::Tensor()), *cx, *cy, *workspace, (bool)has_bias);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg__thnn_fused_lstm_cell_backward_impl(tensor *out__, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_lstm_cell_backward_impl((grad_hy ? *grad_hy : torch::Tensor()), (grad_cy ? *grad_cy : torch::Tensor()), *cx, *cy, *workspace, (bool)has_bias);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__thnn_fused_lstm_cell_backward_impl_out(tensor *out__, tensor out0, tensor out1, tensor out2, tensor grad_hy, tensor grad_cy, tensor cx, tensor cy, tensor workspace, int has_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_lstm_cell_backward_impl_out(*out0, *out1, *out2, (grad_hy ? *grad_hy : torch::Tensor()), (grad_cy ? *grad_cy : torch::Tensor()), *cx, *cy, *workspace, (bool)has_bias);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__thnn_fused_lstm_cell_out(tensor *out__, tensor out0, tensor out1, tensor out2, tensor input_gates, tensor hidden_gates, tensor cx, tensor input_bias, tensor hidden_bias) {
  PROTECT(
    auto outputs__ = torch::_thnn_fused_lstm_cell_out(*out0, *out1, *out2, *input_gates, *hidden_gates, *cx, (input_bias ? *input_bias : torch::Tensor()), (hidden_bias ? *hidden_bias : torch::Tensor()));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg__to_dense(tensor *out__, tensor self, int dtype, int masked_grad) {
  PROTECT(
    auto outputs__ = self->_to_dense(torch::ScalarType(dtype), (bool)masked_grad);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__to_dense_out(tensor *out__, tensor out, tensor self, int dtype, int masked_grad) {
  PROTECT(
    auto outputs__ = torch::_to_dense_out(*out, *self, torch::ScalarType(dtype), (bool)masked_grad);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__to_sparse_bsc(tensor *out__, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_bsc_out(tensor *out__, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_bsr(tensor *out__, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_bsr_out(tensor *out__, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_csc(tensor *out__, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_csc_out(tensor *out__, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_csr(tensor *out__, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__to_sparse_csr_out(tensor *out__, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg__transformer_encoder_layer_fwd(tensor *out__, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__transformer_encoder_layer_fwd_out(tensor *out__, tensor out, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask, int64_t mask_type_v, int mask_type_null) {
  PROTECT(
...
void atg__upsample_bicubic2d_aa(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bicubic2d_aa_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bicubic2d_aa_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bicubic2d_aa_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bilinear2d_aa(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bilinear2d_aa_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bilinear2d_aa_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_bilinear2d_aa_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact1d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg__upsample_nearest_exact1d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg__upsample_nearest_exact1d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg__upsample_nearest_exact1d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg__upsample_nearest_exact2d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact2d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact2d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact2d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact3d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact3d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact3d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg__upsample_nearest_exact3d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_aminmax(tensor *out__, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_aminmax_out(tensor *out__, tensor min, tensor max, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_argmax(tensor *out__, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_argmax_out(tensor *out__, tensor out, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_argmin(tensor *out__, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_argmin_out(tensor *out__, tensor out, tensor self, int64_t dim_v, int dim_null, int keepdim) {
  PROTECT(
...
void atg_as_strided(tensor *out__, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_as_strided_(tensor *out__, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_as_strided_copy(tensor *out__, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_as_strided_copy_out(tensor *out__, tensor out, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_as_strided_scatter(tensor *out__, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_as_strided_scatter_out(tensor *out__, tensor out, tensor self, tensor src, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset_v, int storage_offset_null) {
  PROTECT(
...
void atg_avg_pool2d(tensor *out__, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_avg_pool2d_backward(tensor *out__, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_avg_pool2d_out(tensor *out__, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_avg_pool3d(tensor *out__, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_avg_pool3d_backward(tensor *out__, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_avg_pool3d_out(tensor *out__, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override_v, int divisor_override_null) {
  PROTECT(
...
void atg_bitwise_and_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_and(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_and_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_and_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_left_shift_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_left_shift(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_left_shift_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
...
void atg_bitwise_or_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_or(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_or_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_or_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_right_shift_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_right_shift(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_right_shift_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
...
void atg_bitwise_xor_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_xor(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bitwise_xor_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::bitwise_xor_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bucketize_scalar(tensor *out__, scalar self, tensor boundaries, int out_int32, int right) {
  PROTECT(
    auto outputs__ = torch::bucketize(*self, *boundaries, (bool)out_int32, (bool)right);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_bucketize_scalar_out(tensor *out__, tensor out, scalar self, tensor boundaries, int out_int32, int right) {
  PROTECT(
...
void atg_cdist(tensor *out__, tensor x1, tensor x2, double p, int64_t compute_mode_v, int compute_mode_null) {
  PROTECT(
...
void atg_clone_out(tensor *out__, tensor out, tensor self) {
  PROTECT(
...
void atg_conv1d_padding(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
    auto outputs__ = torch::conv1d(*input, *weight, (bias ? *bias : torch::Tensor()), torch::IntArrayRef(stride_data, stride_len), std::string(padding), torch::IntArrayRef(dilation_data, dilation_len), groups);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_conv2d_padding(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
    auto outputs__ = torch::conv2d(*input, *weight, (bias ? *bias : torch::Tensor()), torch::IntArrayRef(stride_data, stride_len), std::string(padding), torch::IntArrayRef(dilation_data, dilation_len), groups);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_conv3d_padding(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
    auto outputs__ = torch::conv3d(*input, *weight, (bias ? *bias : torch::Tensor()), torch::IntArrayRef(stride_data, stride_len), std::string(padding), torch::IntArrayRef(dilation_data, dilation_len), groups);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_copy(tensor *out__, tensor self, tensor src, int non_blocking) {
  PROTECT(
...
void atg_copy_out(tensor *out__, tensor out, tensor self, tensor src, int non_blocking) {
  PROTECT(
...
void atg_count_nonzero(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len) {
  PROTECT(
...
void atg_count_nonzero_out(tensor *out__, tensor out, tensor self, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_cross(tensor *out__, tensor self, tensor other, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_cross_out(tensor *out__, tensor out, tensor self, tensor other, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_cumprod_(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = self->cumprod_(dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_cumprod_out(tensor *out__, tensor out, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::cumprod_out(*out, *self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_cumsum_(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = self->cumsum_(dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_cumsum_out(tensor *out__, tensor out, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::cumsum_out(*out, *self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_div_out_mode(tensor *out__, tensor out, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::div_out(*out, *self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_div_scalar_mode(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::div(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_div_scalar_mode_(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->div_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_div_scalar_mode_out(tensor *out__, tensor out, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::div_out(*out, *self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_div_tensor_mode(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::div(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_div_tensor_mode_(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->div_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_divide_out_mode(tensor *out__, tensor out, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::divide_out(*out, *self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_divide_scalar_mode(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::divide(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_divide_scalar_mode_(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->divide_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_divide_tensor_mode(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::divide(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_divide_tensor_mode_(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->divide_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_einsum(tensor *out__, char * equation, tensor *tensors_data, int tensors_len, int64_t *path_data, int path_len) {
  PROTECT(
    auto outputs__ = torch::einsum(std::string(equation), of_carray_tensor(tensors_data, tensors_len), path_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(path_data, path_len)));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_embedding_bag_padding_idx(tensor *out__, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx_v, int padding_idx_null) {
  PROTECT(
...
void atg_fft_fft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_fft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_fft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_fft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fft_fftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_fftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_fftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fft_hfft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_hfft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_hfft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_hfft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_hfftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_hfftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_hfftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ifftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ifftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fft_ihfft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ihfft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ihfft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ihfft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ihfftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_ihfftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_ihfftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_irfftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_irfftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_rfft(tensor *out__, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfft(*self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_rfft2(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfft2(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_rfft2_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfft2_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), torch::IntArrayRef(dim_data, dim_len), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_rfft_out(tensor *out__, tensor out, tensor self, int64_t n_v, int n_null, int64_t dim, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfft_out(*out, *self, n_null ? c10::nullopt : c10::optional<int64_t>(n_v), dim, std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_fft_rfftn(tensor *out__, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfftn(*self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_fft_rfftn_out(tensor *out__, tensor out, tensor self, int64_t *s_data, int s_len, int64_t *dim_data, int dim_len, char * norm) {
  PROTECT(
    auto outputs__ = torch::fft_rfftn_out(*out, *self, s_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(s_data, s_len)), dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), std::string(norm));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_float_power_scalar(tensor *out__, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::float_power(*self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power_scalar_out(tensor *out__, tensor out, scalar self, tensor exponent) {
  PROTECT(
...
void atg_from_file(tensor *out__, char * filename, int shared, int64_t size_v, int size_null, int options_kind, int options_device) {
  PROTECT(
    auto outputs__ = torch::from_file(std::string(filename), (bool)shared, size_null ? c10::nullopt : c10::optional<int64_t>(size_v), at::device(device_of_int(options_device)).dtype(at::ScalarType(options_kind)));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_from_file_out(tensor *out__, tensor out, char * filename, int shared, int64_t size_v, int size_null) {
  PROTECT(
    auto outputs__ = torch::from_file_out(*out, std::string(filename), (bool)shared, size_null ? c10::nullopt : c10::optional<int64_t>(size_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_gelu(tensor *out__, tensor self, char * approximate) {
  PROTECT(
    auto outputs__ = torch::gelu(*self, std::string(approximate));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_gelu_(tensor *out__, tensor self, char * approximate) {
  PROTECT(
    auto outputs__ = torch::gelu_(*self, std::string(approximate));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_gelu_backward(tensor *out__, tensor grad_output, tensor self, char * approximate) {
  PROTECT(
    auto outputs__ = torch::gelu_backward(*grad_output, *self, std::string(approximate));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_gelu_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, tensor self, char * approximate) {
  PROTECT(
    auto outputs__ = torch::gelu_backward_out(*grad_input, *grad_output, *self, std::string(approximate));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_gelu_out(tensor *out__, tensor out, tensor self, char * approximate) {
  PROTECT(
    auto outputs__ = torch::gelu_out(*out, *self, std::string(approximate));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_index_reduce(tensor *out__, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = torch::index_reduce(*self, dim, *index, *source, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_index_reduce_(tensor *out__, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = self->index_reduce_(dim, *index, *source, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_index_reduce_out(tensor *out__, tensor out, tensor self, int64_t dim, tensor index, tensor source, char * reduce, int include_self) {
  PROTECT(
    auto outputs__ = torch::index_reduce_out(*out, *self, dim, *index, *source, std::string(reduce), (bool)include_self);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_istft(tensor *out__, tensor self, int64_t n_fft, int64_t hop_length_v, int hop_length_null, int64_t win_length_v, int win_length_null, tensor window, int center, int normalized, int onesided, int64_t length_v, int length_null, int return_complex) {
  PROTECT(
...
void atg_linalg_cond_p_str(tensor *out__, tensor self, char * p) {
  PROTECT(
    auto outputs__ = torch::linalg_cond(*self, std::string(p));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_cond_p_str_out(tensor *out__, tensor out, tensor self, char * p) {
  PROTECT(
    auto outputs__ = torch::linalg_cond_out(*out, *self, std::string(p));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_eigh(tensor *out__, tensor self, char * UPLO) {
  PROTECT(
    auto outputs__ = torch::linalg_eigh(*self, std::string(UPLO));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_linalg_eigh_eigvals(tensor *out__, tensor eigvals, tensor eigvecs, tensor self, char * UPLO) {
  PROTECT(
    auto outputs__ = torch::linalg_eigh_out(*eigvals, *eigvecs, *self, std::string(UPLO));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_linalg_eigvalsh(tensor *out__, tensor self, char * UPLO) {
  PROTECT(
    auto outputs__ = torch::linalg_eigvalsh(*self, std::string(UPLO));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_eigvalsh_out(tensor *out__, tensor out, tensor self, char * UPLO) {
  PROTECT(
    auto outputs__ = torch::linalg_eigvalsh_out(*out, *self, std::string(UPLO));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_lstsq(tensor *out__, tensor self, tensor b, double rcond_v, int rcond_null, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_lstsq(*self, *b, rcond_null ? c10::nullopt : c10::optional<double>(rcond_v), std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg_linalg_lstsq_out(tensor *out__, tensor solution, tensor residuals, tensor rank, tensor singular_values, tensor self, tensor b, double rcond_v, int rcond_null, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_lstsq_out(*solution, *residuals, *rank, *singular_values, *self, *b, rcond_null ? c10::nullopt : c10::optional<double>(rcond_v), std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
    out__[3] = new torch::Tensor(std::get<3>(outputs__));
...
void atg_linalg_matrix_rank_atol_rtol_float(tensor *out__, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian) {
  PROTECT(
...
void atg_linalg_matrix_rank_atol_rtol_float_out(tensor *out__, tensor out, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian) {
  PROTECT(
...
void atg_linalg_pinv_atol_rtol_float(tensor *out__, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian) {
  PROTECT(
...
void atg_linalg_pinv_atol_rtol_float_out(tensor *out__, tensor out, tensor self, double atol_v, int atol_null, double rtol_v, int rtol_null, int hermitian) {
  PROTECT(
...
void atg_linalg_qr(tensor *out__, tensor A, char * mode) {
  PROTECT(
    auto outputs__ = torch::linalg_qr(*A, std::string(mode));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_linalg_qr_out(tensor *out__, tensor Q, tensor R, tensor A, char * mode) {
  PROTECT(
    auto outputs__ = torch::linalg_qr_out(*Q, *R, *A, std::string(mode));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_linalg_svd(tensor *out__, tensor A, int full_matrices, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_svd(*A, (bool)full_matrices, std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_linalg_svd_u(tensor *out__, tensor U, tensor S, tensor Vh, tensor A, int full_matrices, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_svd_out(*U, *S, *Vh, *A, (bool)full_matrices, std::string(driver));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_linalg_svdvals(tensor *out__, tensor A, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_svdvals(*A, std::string(driver));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_svdvals_out(tensor *out__, tensor out, tensor A, char * driver) {
  PROTECT(
    auto outputs__ = torch::linalg_svdvals_out(*out, *A, std::string(driver));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_vander(tensor *out__, tensor x, int64_t n_v, int n_null) {
  PROTECT(
...
void atg_log_softmax_int_out(tensor *out__, tensor out, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::log_softmax_out(*out, *self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_logit(tensor *out__, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_logit_(tensor *out__, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_logit_backward(tensor *out__, tensor grad_output, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_logit_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_logit_out(tensor *out__, tensor out, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_mean_dim(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::mean(*self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_mean_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::mean_out(*out, *self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
tensor *atg_meshgrid_indexing(tensor *tensors_data, int tensors_len, char * indexing) {
  PROTECT(
    auto outputs__ = torch::meshgrid(of_carray_tensor(tensors_data, tensors_len), std::string(indexing));
    int sz = outputs__.size();
    torch::Tensor **out__ = (torch::Tensor**)malloc((sz + 1) * sizeof(torch::Tensor*));
    for (int i = 0; i < sz; ++i)
      out__[i] = new torch::Tensor(outputs__[i]);
...
void atg_nan_to_num(tensor *out__, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null) {
  PROTECT(
...
void atg_nan_to_num_(tensor *out__, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null) {
  PROTECT(
...
void atg_nan_to_num_out(tensor *out__, tensor out, tensor self, double nan_v, int nan_null, double posinf_v, int posinf_null, double neginf_v, int neginf_null) {
  PROTECT(
...
void atg_nanmean(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::nanmean(*self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_nanmean_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::nanmean_out(*out, *self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_nanquantile(tensor *out__, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile(*self, *q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_nanquantile_out(tensor *out__, tensor out, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile_out(*out, *self, *q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_nanquantile_scalar(tensor *out__, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile(*self, q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nanquantile_scalar_out(tensor *out__, tensor out, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile_out(*out, *self, q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nansum(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::nansum(*self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_nansum_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::nansum_out(*out, *self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_native_norm_scalaropt_dim_dtype(tensor *out__, tensor self, scalar p, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::native_norm(*self, *p, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_native_norm_scalaropt_dim_dtype_out(tensor *out__, tensor out, tensor self, scalar p, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::native_norm_out(*out, *self, *p, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_norm_dtype_out(tensor *out__, tensor out, tensor self, scalar p, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::norm_out(*out, *self, *p, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_norm_scalaropt_dim_dtype(tensor *out__, tensor self, scalar p, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::norm(*self, *p, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_norm_scalaropt_dtype(tensor *out__, tensor self, scalar p, int dtype) {
  PROTECT(
    auto outputs__ = torch::norm(*self, *p, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_norm_scalaropt_dtype_out(tensor *out__, tensor out, tensor self, scalar p, int dtype) {
  PROTECT(
    auto outputs__ = torch::norm_out(*out, *self, *p, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_pad(tensor *out__, tensor self, int64_t *pad_data, int pad_len, char * mode, double value_v, int value_null) {
  PROTECT(
    auto outputs__ = torch::pad(*self, torch::IntArrayRef(pad_data, pad_len), std::string(mode), value_null ? c10::nullopt : c10::optional<double>(value_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_pow_scalar(tensor *out__, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::pow(*self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_pow_scalar_out(tensor *out__, tensor out, scalar self, tensor exponent) {
  PROTECT(
...
void atg_prod_int_out(tensor *out__, tensor out, tensor self, int64_t dim, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::prod_out(*out, *self, dim, (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_prod_out(tensor *out__, tensor out, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::prod_out(*out, *self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantile(tensor *out__, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile(*self, *q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_quantile_out(tensor *out__, tensor out, tensor self, tensor q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile_out(*out, *self, *q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_quantile_scalar(tensor *out__, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile(*self, q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_quantile_scalar_out(tensor *out__, tensor out, tensor self, double q, int64_t dim_v, int dim_null, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile_out(*out, *self, q, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_quantize_per_channel(tensor *out__, tensor self, tensor scales, tensor zero_points, int64_t axis, int dtype) {
  PROTECT(
    auto outputs__ = torch::quantize_per_channel(*self, *scales, *zero_points, axis, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantize_per_channel_out(tensor *out__, tensor out, tensor self, tensor scales, tensor zero_points, int64_t axis, int dtype) {
  PROTECT(
    auto outputs__ = torch::quantize_per_channel_out(*out, *self, *scales, *zero_points, axis, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantize_per_tensor(tensor *out__, tensor self, double scale, int64_t zero_point, int dtype) {
  PROTECT(
    auto outputs__ = torch::quantize_per_tensor(*self, scale, zero_point, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantize_per_tensor_dynamic(tensor *out__, tensor self, int dtype, int reduce_range) {
  PROTECT(
    auto outputs__ = torch::quantize_per_tensor_dynamic(*self, torch::ScalarType(dtype), (bool)reduce_range);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantize_per_tensor_dynamic_out(tensor *out__, tensor out, tensor self, int dtype, int reduce_range) {
  PROTECT(
    auto outputs__ = torch::quantize_per_tensor_dynamic_out(*out, *self, torch::ScalarType(dtype), (bool)reduce_range);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_quantize_per_tensor_out(tensor *out__, tensor out, tensor self, double scale, int64_t zero_point, int dtype) {
  PROTECT(
    auto outputs__ = torch::quantize_per_tensor_out(*out, *self, scale, zero_point, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
tensor *atg_quantize_per_tensor_tensors(tensor *tensors_data, int tensors_len, tensor scales, tensor zero_points, int dtype) {
  PROTECT(
    auto outputs__ = torch::quantize_per_tensor(of_carray_tensor(tensors_data, tensors_len), *scales, *zero_points, torch::ScalarType(dtype));
    int sz = outputs__.size();
    torch::Tensor **out__ = (torch::Tensor**)malloc((sz + 1) * sizeof(torch::Tensor*));
    for (int i = 0; i < sz; ++i)
      out__[i] = new torch::Tensor(outputs__[i]);
...
void atg_quantize_per_tensor_tensors_out(tensor *out_data, int out_len, tensor *tensors_data, int tensors_len, tensor scales, tensor zero_points, int dtype) {
  PROTECT(
    torch::quantize_per_tensor_out(of_carray_tensor(out_data, out_len), of_carray_tensor(tensors_data, tensors_len), *scales, *zero_points, torch::ScalarType(dtype));
  )
}
...
void atg_random_from(tensor *out__, tensor self, int64_t from, int64_t to_v, int to_null) {
  PROTECT(
...
void atg_random_from_(tensor *out__, tensor self, int64_t from, int64_t to_v, int to_null) {
  PROTECT(
...
void atg_random_from_out(tensor *out__, tensor out, tensor self, int64_t from, int64_t to_v, int to_null) {
  PROTECT(
...
void atg_remainder_scalar_tensor(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::remainder(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_remainder_scalar_tensor_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::remainder_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_repeat_interleave(tensor *out__, tensor repeats, int64_t output_size_v, int output_size_null) {
  PROTECT(
...
void atg_repeat_interleave_self_int(tensor *out__, tensor self, int64_t repeats, int64_t dim_v, int dim_null, int64_t output_size_v, int output_size_null) {
  PROTECT(
...
void atg_repeat_interleave_self_tensor(tensor *out__, tensor self, tensor repeats, int64_t dim_v, int dim_null, int64_t output_size_v, int output_size_null) {
  PROTECT(
    auto outputs__ = torch::repeat_interleave(*self, *repeats, dim_null ? c10::nullopt : c10::optional<int64_t>(dim_v), output_size_null ? c10::nullopt : c10::optional<int64_t>(output_size_v));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_repeat_interleave_tensor_out(tensor *out__, tensor out, tensor repeats, int64_t output_size_v, int output_size_null) {
  PROTECT(
...
void atg_scaled_dot_product_attention(tensor *out__, tensor query, tensor key, tensor value, tensor attn_mask, double dropout_p, int is_causal, double scale_v, int scale_null) {
  PROTECT(
...
void atg_scatter_reduce(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce) {
  PROTECT(
    auto outputs__ = torch::scatter(*self, dim, *index, *src, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_scatter_reduce_(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce) {
  PROTECT(
    auto outputs__ = self->scatter_(dim, *index, *src, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_scatter_reduce_out(tensor *out__, tensor out, tensor self, int64_t dim, tensor index, tensor src, char * reduce) {
  PROTECT(
    auto outputs__ = torch::scatter_out(*out, *self, dim, *index, *src, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_scatter_value_reduce(tensor *out__, tensor self, int64_t dim, tensor index, scalar value, char * reduce) {
  PROTECT(
    auto outputs__ = torch::scatter(*self, dim, *index, *value, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_scatter_value_reduce_(tensor *out__, tensor self, int64_t dim, tensor index, scalar value, char * reduce) {
  PROTECT(
    auto outputs__ = self->scatter_(dim, *index, *value, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_scatter_value_reduce_out(tensor *out__, tensor out, tensor self, int64_t dim, tensor index, scalar value, char * reduce) {
  PROTECT(
    auto outputs__ = torch::scatter_out(*out, *self, dim, *index, *value, std::string(reduce));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_searchsorted(tensor *out__, tensor sorted_sequence, tensor self, int out_int32, int right, char * side, tensor sorter) {
  PROTECT(
    auto outputs__ = torch::searchsorted(*sorted_sequence, *self, (bool)out_int32, (bool)right, std::string(side), (sorter ? *sorter : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_searchsorted_scalar(tensor *out__, tensor sorted_sequence, scalar self, int out_int32, int right, char * side, tensor sorter) {
  PROTECT(
    auto outputs__ = torch::searchsorted(*sorted_sequence, *self, (bool)out_int32, (bool)right, std::string(side), (sorter ? *sorter : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_searchsorted_scalar_out(tensor *out__, tensor out, tensor sorted_sequence, scalar self, int out_int32, int right, char * side, tensor sorter) {
  PROTECT(
    auto outputs__ = torch::searchsorted_out(*out, *sorted_sequence, *self, (bool)out_int32, (bool)right, std::string(side), (sorter ? *sorter : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_searchsorted_tensor_out(tensor *out__, tensor out, tensor sorted_sequence, tensor self, int out_int32, int right, char * side, tensor sorter) {
  PROTECT(
    auto outputs__ = torch::searchsorted_out(*out, *sorted_sequence, *self, (bool)out_int32, (bool)right, std::string(side), (sorter ? *sorter : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_segment_reduce(tensor *out__, tensor data, char * reduce, tensor lengths, tensor indices, tensor offsets, int64_t axis, int unsafe, scalar initial) {
  PROTECT(
    auto outputs__ = torch::segment_reduce(*data, std::string(reduce), (lengths ? *lengths : torch::Tensor()), (indices ? *indices : torch::Tensor()), (offsets ? *offsets : torch::Tensor()), axis, (bool)unsafe, *initial);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_segment_reduce_out(tensor *out__, tensor out, tensor data, char * reduce, tensor lengths, tensor indices, tensor offsets, int64_t axis, int unsafe, scalar initial) {
  PROTECT(
    auto outputs__ = torch::segment_reduce_out(*out, *data, std::string(reduce), (lengths ? *lengths : torch::Tensor()), (indices ? *indices : torch::Tensor()), (offsets ? *offsets : torch::Tensor()), axis, (bool)unsafe, *initial);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
int64_t atg_size(tensor self, int64_t dim) {
  PROTECT(
...
void atg_slice(tensor *out__, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step) {
  PROTECT(
...
void atg_slice_copy(tensor *out__, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step) {
  PROTECT(
...
void atg_slice_copy_tensor_out(tensor *out__, tensor out, tensor self, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step) {
  PROTECT(
...
void atg_slice_scatter(tensor *out__, tensor self, tensor src, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step) {
  PROTECT(
...
void atg_slice_scatter_out(tensor *out__, tensor out, tensor self, tensor src, int64_t dim, int64_t start_v, int start_null, int64_t end_v, int end_null, int64_t step) {
  PROTECT(
...
void atg_softmax_int_out(tensor *out__, tensor out, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::softmax_out(*out, *self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_special_log_softmax(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::special_log_softmax(*self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_special_logit(tensor *out__, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_special_logit_out(tensor *out__, tensor out, tensor self, double eps_v, int eps_null) {
  PROTECT(
...
void atg_special_softmax(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
    auto outputs__ = torch::special_softmax(*self, dim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_special_xlog1py_self_scalar(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_xlog1py(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_special_xlog1py_self_scalar_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_xlog1py_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_special_xlogy_self_scalar(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_xlogy(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_special_xlogy_self_scalar_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_xlogy_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_special_zeta_self_scalar(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_zeta(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_special_zeta_self_scalar_out(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::special_zeta_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_stft(tensor *out__, tensor self, int64_t n_fft, int64_t hop_length_v, int hop_length_null, int64_t win_length_v, int win_length_null, tensor window, int normalized, int onesided, int return_complex) {
  PROTECT(
...
void atg_stft_center(tensor *out__, tensor self, int64_t n_fft, int64_t hop_length_v, int hop_length_null, int64_t win_length_v, int win_length_null, tensor window, int center, char * pad_mode, int normalized, int onesided, int return_complex) {
  PROTECT(
    auto outputs__ = torch::stft(*self, n_fft, hop_length_null ? c10::nullopt : c10::optional<int64_t>(hop_length_v), win_length_null ? c10::nullopt : c10::optional<int64_t>(win_length_v), (window ? *window : torch::Tensor()), (bool)center, std::string(pad_mode), (bool)normalized, (bool)onesided, (bool)return_complex);
    out__[0] = new torch::Tensor(outputs__);
  )
}

int64_t atg_stride(tensor self, int64_t dim) {
  PROTECT(
...
void atg_sum_dim_intlist(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::sum(*self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_sum_intlist_out(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::sum_out(*out, *self, dim_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(dim_data, dim_len)), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_sum_out(tensor *out__, tensor out, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::sum_out(*out, *self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_take_along_dim(tensor *out__, tensor self, tensor indices, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_take_along_dim_out(tensor *out__, tensor out, tensor self, tensor indices, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_to_dense(tensor *out__, tensor self, int dtype, int masked_grad) {
  PROTECT(
    auto outputs__ = self->to_dense(torch::ScalarType(dtype), (bool)masked_grad);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_to_device(tensor *out__, tensor self, int device, int dtype, int non_blocking, int copy) {
  PROTECT(
    auto outputs__ = self->to(device_of_int(device), torch::ScalarType(dtype), (bool)non_blocking, (bool)copy);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_to_mkldnn(tensor *out__, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = self->to_mkldnn(torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_to_mkldnn_out(tensor *out__, tensor out, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::to_mkldnn_out(*out, *self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_unique_consecutive(tensor *out__, tensor self, int return_inverse, int return_counts, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_unique_consecutive_out(tensor *out__, tensor out0, tensor out1, tensor out2, tensor self, int return_inverse, int return_counts, int64_t dim_v, int dim_null) {
  PROTECT(
...
void atg_upsample_bicubic2d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bicubic2d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bicubic2d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bicubic2d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bilinear2d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bilinear2d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bilinear2d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_bilinear2d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_linear1d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_linear1d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_linear1d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_linear1d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_nearest1d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_nearest1d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_nearest1d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_nearest1d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_v, int scales_null) {
  PROTECT(
...
void atg_upsample_nearest2d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest2d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest2d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest2d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest3d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest3d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest3d_backward_grad_input(tensor *out__, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_nearest3d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_trilinear3d(tensor *out__, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_trilinear3d_backward(tensor *out__, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_upsample_trilinear3d_out(tensor *out__, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_d_v, int scales_d_null, double scales_h_v, int scales_h_null, double scales_w_v, int scales_w_null) {
  PROTECT(
...
void atg_vander(tensor *out__, tensor x, int64_t n_v, int n_null, int increasing) {
  PROTECT(
...
void atg_view_copy_dtype(tensor *out__, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::view_copy(*self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_view_copy_dtype_out(tensor *out__, tensor out, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::view_copy_out(*out, *self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_view_dtype(tensor *out__, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = self->view(torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_where_scalar(tensor *out__, tensor condition, scalar self, scalar other) {
  PROTECT(
...
void atg_where_scalarself(tensor *out__, tensor condition, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::where(*condition, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy_outscalar_self(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::xlogy_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy_scalar_self(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::xlogy(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
