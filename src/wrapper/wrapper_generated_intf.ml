...
module type S = sig
  ...
  val _scaled_dot_product_cudnn_attention
    :  query:t
    -> key:t
    -> value:t
    -> dropout_p:float
  ...
  val can_cast : from:Kind.packed -> to_:Kind.packed -> bool
  ...
  val index_tensor_out : out:t -> t -> indices:t option list -> t
  val indices : t -> t
  ...
  val is_pinned : t -> device:Device.t -> bool
